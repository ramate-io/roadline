/// Original code from https://github.com/TotalKrill/bevy_ui_anchor
...
impl AnchorPoint {
	pub fn topleft() -> Self {
		Self { horizontal: HorizontalAnchor::Left, vertical: VerticalAnchor::Top }
	}
	pub fn topright() -> Self {
		Self { horizontal: HorizontalAnchor::Right, vertical: VerticalAnchor::Top }
	}
	pub fn bottomleft() -> Self {
		Self { horizontal: HorizontalAnchor::Left, vertical: VerticalAnchor::Bottom }
	}
	pub fn bottomright() -> Self {
		Self { horizontal: HorizontalAnchor::Right, vertical: VerticalAnchor::Bottom }
	}
	pub fn middle() -> Self {
		Self { horizontal: HorizontalAnchor::Mid, vertical: VerticalAnchor::Mid }
	}
}
...
impl<SingleCameraMarker: Component> AnchorUiPlugin<SingleCameraMarker> {
	pub fn new() -> Self {
		Self { _component: PhantomData::default() }
	}
}
